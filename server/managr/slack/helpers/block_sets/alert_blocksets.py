        ...
        return [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f":heavy_check_mark: *{meeting.zoom_account.user.full_name}* meeting with *{meeting.opportunity.title}* scored *{meeting.meeting_score}*, it was a {action_choice.title}. Click below to see the summary.",
                },
            },
            {
                "type": "actions",
