...
MESSAGE_DELIVERED_OPTIONS = (
    TWILIO_MESSAGE_DELIVERED, TWILIO_MESSAGE_SENT,
)
MESSAGE_NOT_DELIVERED_OPTIONS = (
    TWILIO_MESSAGE_UNDELIVERED, TWILIO_MESSAGE_FAILED,
)

MESSAGE_PENDING_OPTIONS = (
    TWILIO_MESSAGE_SENDING
)
...
# Forecast KPIs date-range presets
