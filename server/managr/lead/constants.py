...
LEAD_CREATED_API = "Lead.CREATED.API"
LEAD_UPDATED_API = "Lead.UPDATED.API"
LEAD_DELETED_API = "Lead.DELETED.API"
LEAD_CLAIMED_API = "Lead.CLAIMED.API"
LEAD_RELEASED_API = "Lead.RELEASED.API"
LEAD_CLOSED_API = "Lead.CLOSED.API"
