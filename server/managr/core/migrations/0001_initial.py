    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('LIMITED', 'LIMITED'), ('MANAGER', 'MANAGER')], default='MANAGER', max_length=255)),
                ...
                ('magic_token', models.UUIDField(default=uuid.uuid4, editable=False, help_text='The magic token is a randomly-generated uuid that can be used to identify the user in a non-password based login flow. ')),
                ('magic_token_expiration', models.DateTimeField(help_text='The datetime when the magic token is expired.', null=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='organization.Organization')),
