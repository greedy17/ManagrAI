    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forecast_strength', models.CharField(blank=True, choices=[('50/50', '50/50'), ('NA', 'NA'), ('STRONG', 'Strong'), ('FUTURE', 'Future'), ('VERBAL', 'Verbal'), ('CLOSED', 'Closed')], max_length=255, null=True)),
                ...
                ('updated_close_date', models.DateTimeField(blank=True, max_length=255, null=True)),
                ('next_steps', models.TextField(blank=True, help_text='populates secondary description', null=True)),
                ('sentiment', models.CharField(blank=True, choices=[('GREAT', 'Great'), ('NOT WELL', 'Not Well'), ('N/A', 'N/A')], max_length=255, null=True)),
                ('prev_forecast', models.CharField(blank=True, choices=[('50/50', '50/50'), ('NA', 'NA'), ('STRONG', 'Strong'), ('FUTURE', 'Future'), ('VERBAL', 'Verbal'), ('CLOSED', 'Closed')], max_length=255, null=True)),
                ...
                ('prev_expected_close_date', models.DateTimeField(blank=True, max_length=255, null=True)),
