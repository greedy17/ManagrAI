        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pmi",
                    models.CharField(
                        blank=True, help_text="personal meeting id", max_length=255, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "should_track",
                    models.CharField(
                        choices=[("NO", "No"), ("YES", "Yes"), ("NOT_SELECTED", "NOT_SELECTED")],
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0, help_text="We make an attempt immedietly and after 2 hours"
                    ),
                ),
                (
                    "scoring_in_progress",
                ...
                (
                    "current_interaction",
                    models.PositiveSmallIntegerField(default=1, help_text="current slack form"),
                ),
                (
                    "is_closed",
                    models.BooleanField(
                ...
                (
                    "participants",
                    models.ManyToManyField(related_name="meetings", to="organization.Contact"),
                ),
                (
                    "zoom_account",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "next_steps",
                    models.TextField(
                        blank=True, help_text="populates secondary description", null=True
                    ),
                ),
                (
                    "sentiment",
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("ZOOM_MEETING__NOT_WELL", "Not Well"),
                            ("ZOOM_MEETING__CANT_TELL", "Can't Tell"),
                        ],
                        max_length=255,
                        null=True,
                    ),
