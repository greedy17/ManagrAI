...
class UserTestCase(TestCase):
    ...
    def test_operand_row_generates_query_string_w_cond(self):
        ...
        self.assertEqual(row.query_str, expected)
    ...
    def test_group_generates_query_string_w_and_cond(self):
        ...
        expected = f"AND ({self.row.query_str})"
        self.assertEqual(self.group.query_str, expected)
    ...
    def test_group_generates_url_string(self):
        ...
        additional_filters = [
            ...
            *[group.query_str for group in self.template.groups.all()],
        ]
        ...
        self.assertEqual(self.template.url_str(self.admin_user), expected)
