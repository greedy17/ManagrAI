...
def OPEN_AI_GET_INSIGHTS(notes, activity, instructions):
    prompt = f"""
    ...
    Excellent communicator focused on strategic management, team accountability, and continuously enhancing PR processes. Here is your task: Review all the notes and user engagement activity related to a contact, most likely a journalist. Then follow the instructions.
