...
USE_INSTAGRAM_API = os.environ.get("USE_TWITTER_API") == "True"
if USE_INSTAGRAM_API:
    INSTAGRAM_APP_KEY = _env_get_required("INSTAGRAM_APP_KEY")
    INSTAGRAM_APP_SECRET = _env_get_required("INSTAGRAM_APP_SECRET")
    INSTAGRAM_REDIRECT_URI = _env_get_required("INSTAGRAM_REDIRECT_URI")
...
GUNICORN_WORKERS = 4
GUNICORN_THREADS = 4
SCRAPY_LOG_LEVEL = "ERROR" if IN_PROD else "DEBUG"
