...
urlpatterns = [
    ...
    path(
        "users/gong/authenticate",
        gong_views.get_gong_authentication,
        name="get_gong_authentication",
    ),
    path("users/gong/authorization", gong_views.get_gong_auth_link, name="get_gong_auth_link",),
    path(
        "users/gong/revoke", gong_views.revoke_gong_access_token, name="revoke_gong_access_token",
    ),
