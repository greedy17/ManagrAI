...
urlpatterns = [
    ...
    path('users/email-auth-token/', core_views.email_auth_token,
         name="get_email_auth_token"),
    path('users/revoke-email-auth/',
         core_views.revoke_access_token, name="revoke_email_auth"),
    path('account-status/', core_views.get_account_status,
    ...
    path('twilio/messages/send', core_views.send_text_message,
         name="twilio_send_text_message"),
...
router.register('email-templates',
                core_views.EmailTemplateViewset, 'email-templates')
router.register('organizations',
...
router.register('lists/remove-from-list',
...
router.register('actionchoices',
                lead_views.ActionChoiceViewSet, 'actionchoices')
router.register('actions', lead_views.ActionViewSet, 'actions')
router.register('lead-activity',
                lead_views.LeadActivityLogViewSet, 'lead-activity')

router.register('action-choices',
