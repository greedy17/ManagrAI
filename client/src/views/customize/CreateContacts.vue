<template>
  <div class="update_opportunity">
    <div class="opportunity_title">
      <h2 style="border-bottom: 3px solid #5f8cff; padding-bottom: 0.5rem">
        Create <span style="color: #ff7649">Contacts</span>
      </h2>
    </div>
    <!-- <div style="text-align: center">
      <label for="one">2/2: </label>
      <progress id="one" max="100" value="100">100%</progress>
    </div> -->
      ...
      <CustomSlackForm
        ...
        :customForm="
          (this.selectedForm = this.allForms.find(
            (f) => f.resource == CONTACT && f.formType == CREATE,
          ))
        "
        :resource="CONTACT"
