      ...
      <div class="welcome">
        ...
        <div style="margin-top: -1.5rem" class="row">
          ...
          >
            ...
            <img
              style="height: 1rem;width:2rem margin-right: 0.25rem; margin-left: 0.5rem"
            ...
            <img
              style="height: 1rem; margin-right: 0.25rem"
              src="@/assets/images/outreach.webp"
              alt=""
            />

            <img
              style="height: 1rem; margin-right: 0.25rem"
              src="@/assets/images/salesloft.svg"
              alt=""
              class="filter-loft"
            />
            <img src="@/assets/images/gmailCal.png" style="margin-right: 0.25rem; height: 1rem" />
            <svg
