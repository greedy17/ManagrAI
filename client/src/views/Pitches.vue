  ...
  data() {
    return {
      ...
      instructionsSuggestions: [
        `A concise blog post targeting millennial moms on behalf of XXX, about ...`,
        `Media pitch to national writers on behalf of XXX, about ...`,
        `Press release on behalf of XXX, announcing ...`,
        `Issue a statement on behalf of XXX, regarding ...`,
        `An informative LinkedIn Post on behalf of XXX catered to XXX about ...`,
        `An entertaining social post on behalf of XXX about ...`,
      ],
      instructions: '',
      copyTip: 'Copy',
      textToCopy: '',
