...
export class SObjectFormBuilderAPI extends ModelAPI {
  ...
  async getObjects(sobject) {
    try {
      const res = await this.client.get(SObjectFormBuilderAPI.ENDPOINT + 'sobject/', { params: { sobject: sobject } })
      return res.data
    } catch (e) {
      apiErrorHandler({ apiName: 'Error Retrieving Data' })(e)
    }
  ...
  async getNotes(resource_id) {
    try {
      const res = await this.client.get(SObjectFormBuilderAPI.ENDPOINT + 'sobject/notes/', { params: { resource_id: resource_id } })
      return res.data
    } catch (e) {
      apiErrorHandler({ apiName: 'Error Retrieving Data' })(e)
    }
