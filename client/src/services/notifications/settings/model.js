...
class NotificationOption {
  ...
  static NOTIFICATION_RESOURCE_OPPORTUNITY = 'OPPORTUNITIY'
  static NOTIFICATION_RESOURCE_ACCOUNT = 'ACCOUNT'
  static NOTIFICATION_RESOURCE_ORGANIZATION = 'ORGANIZATION'
  static NOTIFICATION_RESOURCE_REPORT = 'REPORT'
  static NOTIFICATION_RESOURCE_USER = 'USER'
  static NOTIFICATION_RESOURCES = [
    NotificationOption.NOTIFICATION_RESOURCE_OPPORTUNITY,
    NotificationOption.NOTIFICATION_RESOURCE_ACCOUNT,
    NotificationOption.NOTIFICATION_RESOURCE_ORGANIZATION,
    NotificationOption.NOTIFICATION_RESOURCE_REPORT,
    NotificationOption.NOTIFICATION_RESOURCE_USER,
  ]
